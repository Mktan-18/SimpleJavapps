...
ic1=new ImageIcon(JApps.class.getResource("/com/ic1.jpg"));
ic2=new ImageIcon(JApps.class.getResource("/com/ic2.jpg"));
ic11=new ImageIcon(JApps.class.getResource("/com/ic11.JPG"));
ic22=new ImageIcon(JApps.class.getResource("/com/ic22.JPG"));
             ...
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(TTT1.this,"Computer won! Click reset");
                break;			 
            	 ...
            	 JOptionPane.showMessageDialog(TTT1.this,"Tie Tie! Click reset to play again");
