...
public class JApps extends JFrame {
	...
	public JApps() {
		...
		btnNewButton.setIcon(new ImageIcon(JApps.class.getResource("/com/notepad.jpg")));
		...
		button.setIcon(new ImageIcon(JApps.class.getResource("/com/calculator.jpg")));
		...
		button_1.setIcon(new ImageIcon(JApps.class.getResource("/com/ip.jpg")));
		...
		button_2.setIcon(new ImageIcon(JApps.class.getResource("/com/tictactoe.jpg")));
		
		JButton button_3 = new JButton("");
		button_3.setIcon(new ImageIcon(JApps.class.getResource("/com/picturepuzzle.jpg")));
		...
		button_4.setIcon(new ImageIcon(JApps.class.getResource("/com/wct.jpg")));
		...
		button_5.setIcon(new ImageIcon(JApps.class.getResource("/com/Puzzle Game.jpg")));
		...
		button_6.setIcon(new ImageIcon(JApps.class.getResource("/com/Exam System.jpg")));
		...
		button_7.setIcon(new ImageIcon(JApps.class.getResource("/com/Source Code Generator.jpg")));
